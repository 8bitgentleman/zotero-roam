...
**Status:** ✅ Completed in commit `a30c400` (2026-01-26)

**Changes:**
- ✅ Updated axios to v1.8.2 (fixes security vulnerability)
- ✅ Updated vite to v5.4.19 (fixes security vulnerability)
- ✅ Updated MSW to v2.12.7 (auto-updated with dependencies)
- ✅ All tests pass (37 test files, 397 tests)
...
**Status:** ✅ Completed in commit `9c0f1fc` (2026-01-08)
...
**Changes:**
- ✅ Added new `getItemYear()` function to extract year from `item.meta.parsedDate`
- ✅ Added `Year::` field to metadata after `Publication::`
- ✅ Handles items with/without year gracefully
...
**Changes:**
- ✅ Fixed HTML → Roam markdown conversion for bullets
- ✅ Changed `</li><li>` separator from space to newline
- ✅ List items now properly create individual Roam blocks
...
**Changes:**
- ✅ Added new `'authors_or_editors'` parameter to `getItemCreators()`
- ✅ Shows authors if available, falls back to editors if not
- ✅ Useful for books/collections where editor attribution is primary
...
**Combined Testing for PR #3:** ✅ COMPLETED
```bash
...
**1. PR #1: Security Updates** ⚡ - DONE `a30c400`
- **Effort:** 30 minutes ✅
- **Impact:** HIGH (security) ✅
- **Risk:** LOW ✅
- **Completed:** 2026-01-26

**3. PR #3: Small Bug Fixes** 🎯 - DONE `9c0f1fc`
- **Effort:** 3-4 hours ✅
- **Impact:** MEDIUM-HIGH ✅
- **Risk:** LOW ✅
...
| #6 | Performance improvements | MEDIUM | 6-8h | **Grouped** | 📋 Pending |
| #7 | Batch import | MEDIUM | 4-6h | Separate | 📋 Pending |
| #8 | Evaluate upstream #702 | LOW | 8-12h | Separate | 📋 Pending |
...
### Phase 3 Progress:
- 📋 Recent items import successfully (PR #4 - PENDING)
- 📋 Citation keys work with Zotero 7 (PR #5 - PENDING)
- 📋 Better BibTeX integration confirmed (PR #5 - PENDING)

### Phase 4-5 Progress:
- 📋 Large libraries don't freeze UI (PR #6 - PENDING)
- 📋 Performance metrics available (PR #6 - PENDING)
- 📋 Batch import works (PR #7 - PENDING)
- 📋 Loading indicators help UX (PR #6 - PENDING)

### Longer Term:
- 📋 Upstream PR #702 evaluated (PR #8 - PENDING)
